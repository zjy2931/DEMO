        ...
        var t = {
                  ...
                  , s = {
                    _sample: function(t) {
                        ...
                        if ("number" === r) {
                            ...
                            "object" === r ? n = e : "string" === r && (n = JSON.parse(e));
                    ...
                    _proximate: function(t) {
                        var e = t.base
                          ...
                          , i = function(i) {
                            ...
                            if (Math.abs(i - a) < r)
                                return o;
                            var l = (n = i > a ? t[s = a + r] : t[s = a - r]) - o;
                            return l < r ? o : o + (i - a) / (s - a) * (n > o ? -1 : 1) * l
                        };
                        return i.getSamples = function() {
                            return t
                        }
                        ,
                        i
            ...
            973: (t,e,r)=>{
                ...
                const l = function() {
                    ...
                    n.Z)(t, [{
                        ...
                        value: function() {
                            var t = this._props;
                            this.el && (t.isSoftHide ? this._showByTransform() : this.el.style.display = "block",
                            this._isShown = !0)
                        }
                    }, {
                        key: "_hide",
                        value: function() {
                            this.el && (this._props.isSoftHide ? o().setPrefixedStyle(this.el, "transform", "scale(0)") : this.el.style.display = "none",
                            this._isShown = !1)
                        }
                    }, {
                        ...
                        value: function(t) {
                            return "string" == typeof t && t.match(/stagger/) && (t = o().parseStagger(t, this._index)),
                            "string" == typeof t && t.match(/rand/) && (t = o().parseRand(t)),
                            t
                        }
                    }, {
                        key: "_parsePositionOption",
                        value: function(t, e) {
                            return o().unitOptionMap[t] && (e = o().parseUnit(e).string),
                            e
                        }
                    }, {
                        ...
                        value: function(t, e) {
                            ...
                            !this._skipPropsDelta || !this._skipPropsDelta[t]) {
                                ...
                                var s = "object" === (0,
                                i.Z)(r.end) ? 0 === r.end.value ? 0 : r.end.string : r.end;
                                this._props[t] = s
                            }
                        }
                    }, {
                        ...
                        value: function(t, e) {
                            return e = this._parseOptionString(e),
                            this._parsePositionOption(t, e)
                        }
                    }, {
                        key: "_parseProperty",
                        value: function(t, e) {
                            return "parent" === t ? o().parseEl(e) : (e = this._parsePreArrayProperty(t, e),
                            ...
                            for (var r in this._deltas) {
                                ...
                                if ("array" === i.type) {
                                    ...
                                    for (var l = s ? i.curve(e) : null, u = 0; u < i.delta.length; u++) {
                                        var h = i.delta[u]
                                          , p = s ? l * (i.start[u].value + e * h.value) : i.start[u].value + n * h.value;
                                        a.push({
                                    ...
                                    this._props[r] = s ? i.curve(e) * (i.start + e * i.delta) : i.start + n * i.delta;
                                else if ("unit" === i.type) {
                                    ...
                                    if (s) {
                                        var v = i.curve(e);
                                        _ = parseInt(v * (i.start.r + e * i.delta.r), 10),
                                        f = parseInt(v * (i.start.g + e * i.delta.g), 10),
                                        d = parseInt(v * (i.start.b + e * i.delta.b), 10),
                                        y = parseFloat(v * (i.start.a + e * i.delta.a))
                                    } else
                                        _ = parseInt(i.start.r + n * i.delta.r, 10),
                                        f = parseInt(i.start.g + n * i.delta.g, 10),
                                        d = parseInt(i.start.b + n * i.delta.b, 10),
            ...
            623: (t,e,r)=>{
                ...
                const c = function(t) {
                    ...
                    n.Z)(r, [{
                        ...
                        key: "_render",
                        value: function() {
                            this._isRendered || (this._isRendered = !0,
                        ...
                        value: function(t) {
                            ...
                            if (h().isArray(e[t])) {
                                for (var r = "", s = 0; s < e[t].length; s++) {
                                    var n = e[t][s]
                                      , a = "%" === n.unit ? this.castPercent(n.value) : n.value;
                                    r += "".concat(a, " ")
                                }
                                return e[t] = "0 " === r ? r = "" : r,
                                e[t] = r
                            ...
                            "object" === (0,
                            i.Z)(e[t]) && (r = "%" === e[t].unit ? this.castPercent(e[t].value) : e[t].value,
                            e[t] = 0 === r ? r = "" : r)
                        }
                    }, {
                        key: "castPercent",
                        ...
                        value: function(t, e) {
                            this._state[t] !== e && (this.el.setAttribute(t, e),
                            this._state[t] = e)
                        }
                    }, {
                        key: "_getLength",
                ...
                const h = function(t) {
                    ...
                    s.Z)(r, [{
                        ...
                        value: function() {
                            (0,
                            n.Z)((0,
                            l.Z)(r.prototype), "_declareDefaults", this).call(this),
                        ...
                        value: function() {
                            (0,
                            n.Z)((0,
                            l.Z)(r.prototype), "_draw", this).call(this);
                            var t = this._props
                              , e = null != t.radiusX ? t.radiusX : t.radius
                              , i = null != t.radiusY ? t.radiusY : t.radius
                              , s = e === this._prevRadiusX
                              , a = i === this._prevRadiusY
                              , o = t.points === this._prevPoints;
                            if (!(s && a && o)) {
                                var u = t.width / 2
                                  , h = t.height / 2
                                  , p = u + e
                                  , c = "M".concat(u - e, " ").concat(h, " Q ").concat(u, " ").concat(h - 2 * i, " ").concat(p, " ").concat(h);
                    ...
                    s.Z)(r, [{
                        ...
                        value: function() {
                            ...
                            for (var t = 0; t < this._drawMap.length; t++)
                                "stroke-width" === this._drawMap[t] && this._drawMap.splice(t, 1)
                        }
                    }, {
                        key: "getShape",
                        value: function() {
                        ...
                        value: function() {
                            var t = this._props
                              , e = this._state
                              , i = e.radiusX !== t.radiusX
                              , s = e.radiusY !== t.radiusY
                              , a = e.radius !== t.radius;
                            (i || s || a) && (this.el.setAttribute("transform", this._getScale()),
                            e.radiusX = t.radiusX,
                            e.radiusY = t.radiusY,
                            e.radius = t.radius),
                            this._setAttrIfChanged("stroke-width", t["stroke-width"] / t.maxScale),
                            (0,
                            n.Z)((0,
                            l.Z)(r.prototype), "_draw", this).call(this)
                        }
                        ...
                        value: function() {
                            if (!this._isRendered) {
                                ...
                                var t = this._props;
                                t.parent.innerHTML = '<svg id="js-mojs-shape-canvas" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"><g id="js-mojs-shape-el">'.concat(this.getShape(), "</g></svg>"),
                    ...
                    s.Z)(r, [{
                        ...
                        value: function() {
                            for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++)
                                e[r] = arguments[r];
                            return this._pushTimelineArray(e),
                        ...
                        value: function() {
                            ...
                            for (var i = 0, s = e; i < s.length; i++) {
                                var n = s[i];
                                h().isArray(n) ? this._appendTimelineArray(n) : this._appendTimeline(n, this._timelines.length),
                                this._calcDimentions()
                            }
                            return this
                        }
                        ...
                        value: function(t) {
                            return (0,
                            o.Z)((0,
                            l.Z)(r.prototype), "stop", this).call(this, t),
                        ...
                        value: function() {
                            return (0,
                            o.Z)((0,
                            l.Z)(r.prototype), "reset", this).call(this),
                            this._resetChildren(),
                            this
                        }
                    }, {
                        ...
                        value: function(t, e, i) {
                            t.timeline instanceof r && (t = t.timeline),
                        ...
                        value: function(t) {
                            ...
                            (0,
                            o.Z)((0,
                            l.Z)(r.prototype), "_setStartTime", this).call(this, t),
                        ...
                        value: function(t) {
                            ...
                            for (var i = 0; i < this._timelines.length; i++) {
                                ...
                                s._setStartTime(t, e),
                                e || null == s._prevTime || r || (s._prevTime = s._normPrevTimeForward())
                            }
                        }
                    }, {
                        key: "_refresh",
                        value: function(t) {
                            for (var e = this._timelines.length, i = 0; i < e; i++)
                                this._timelines[i]._refresh(t);
                            (0,
                            o.Z)((0,
                            l.Z)(r.prototype), "_refresh", this).call(this, t)
                        }
                    }, {
                        key: "_declareDefaults",
                        value: function() {
                            null != this._o.duration && (h().error('Duration can not be declared on Timeline, but "'.concat(this._o.duration, '" is. You probably want to use Tween instead.')),
                            this._o.duration = 0),
                            (0,
                            o.Z)((0,
                            l.Z)(r.prototype), "_declareDefaults", this).call(this),
                        ...
                        value: function() {
                            ...
                            (0,
                            o.Z)((0,
                            l.Z)(r.prototype), "_vars", this).call(this)
                        }
                    }]),
                    r
                }(p.Z)
            ...
            755: (t,e,r)=>{
                ...
                const f = function(t) {
                    ...
                    function r() {
                        ...
                        return (0,
                        i.Z)(this, r),
                        null == (t = e.call(this, s))._props.name && t._setSelfName(),
                        (0,
                        l.Z)(t, (0,
                        n.Z)(t))
                    }
                    ...
                    s.Z)(r, [{
                        ...
                        value: function() {
                            ...
                            return "play" === this._state && this._isRunning || (this._props.isReversed = !1,
                        ...
                        value: function() {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
                            return "reverse" === this._state && this._isRunning || (this._props.isReversed = !0,
                        ...
                        key: "pause",
                        value: function() {
                            return "pause" === this._state || "stop" === this._state || (this._removeFromTweener(),
                        ...
                        value: function(t) {
                            var e = this._props;
                            return !e.startTime && this._setStartTime(),
                            this._playTime = null,
                            t < 0 && (t = 0),
                            t > 1 && (t = 1),
                        ...
                        key: "setSpeed",
                        value: function(t) {
                            return this._props.speed = t,
                            "play" !== this._state && "reverse" !== this._state || this._setResumeTime(this._state),
                            this
                        }
                    }, {
                        key: "reset",
                        value: function() {
                            return this._removeFromTweener(),
                        ...
                        value: function() {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0
                              ...
                              , n = "pause" === i
                              , a = "play" === i || n && "play" === s
                              , o = "reverse" === i || n && "reverse" === s
                              , l = a && "reverse" === e || o && "play" === e;
                            return this._progressTime = this._progressTime >= r.repeatTime ? 0 : this._progressTime,
                            l && (this._progressTime = r.repeatTime - this._progressTime),
                        ...
                        value: function(t) {
                            ...
                            null != this._prevTime && (this._prevTime = "play" === t ? this._normPrevTimeForward() : this._props.endTime - this._progressTime)
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            h.Z[t] = null == h.Z[t] ? 1 : ++h.Z[t],
                            this._props.name = "".concat(this._props.nameBase, " ").concat(h.Z[t])
                        }
                    }, {
                        ...
                        value: function(t) {
                            ...
                            var e = "pause" === this._prevState
                              ...
                              , n = i || s;
                            "play" !== t && "reverse" !== t || !(r || e) || this._playbackStart(),
                        ...
                        value: function() {
                            ...
                            this._state = "stop",
                            this._props.delay < 0 && (this._negativeShift = this._props.delay,
                            this._props.delay = 0),
                            this._calcDimentions()
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            (0,
                            a.Z)((0,
                            u.Z)(r.prototype), "_extendDefaults", this).call(this);
                            var t = this._props;
                            t.easing = c().parseEasing(t.easing),
                            t.easing._parent = this,
                            null != t.backwardEasing && (t.backwardEasing = c().parseEasing(t.backwardEasing),
                        ...
                        value: function(t) {
                            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]
                              , r = this._props
                              , i = r.shiftTime || 0;
                            e && (this._isCompleted = !1,
                            this._isRepeatCompleted = !1,
                            this._isStarted = !1);
                            var s = null == t ? performance.now() : t;
                            return r.startTime = s + r.delay + this._negativeShift + i,
                        ...
                        value: function(t, e, r, i) {
                            var s = this._props;
                            null == this._prevTime && null != e && (this._props.speed && this._playTime && (this._prevTime = this._playTime + this._props.speed * (e - this._playTime)),
                            this._wasUknownUpdate = !0);
                            var n = s.startTime - s.delay;
                            if (s.speed && this._playTime && (t = this._playTime + s.speed * (t - this._playTime)),
                            Math.abs(s.endTime - t) < 1e-8 && (t = s.endTime),
                            i && null != r) {
                                var a = this._getPeriod(t)
                                  , o = !(!s.isYoyo || !this._props.repeat || a % 2 != 1);
                                if (this._timelines)
                                    for (var l = 0; l < this._timelines.length; l++)
                                        this._timelines[l]._update(t, e, r, i);
                                1 === i ? r ? (this._prevTime = t + 1,
                                this._repeatStart(t, o),
                                this._start(t, o)) : (this._prevTime = t - 1,
                                this._repeatComplete(t, o),
                                this._complete(t, o)) : -1 === i && (r ? (this._prevTime = t - 1,
                                this._repeatComplete(t, o),
                                this._complete(t, o)) : this._prevTime >= s.startTime && this._prevTime <= s.endTime && (this._prevTime = t + 1,
                                this._repeatStart(t, o),
                                this._start(t, o),
                                this._isCompleted = !0)),
                                this._prevTime = void 0
                            }
                            return t > n && t < s.endTime ? this._progressTime = t - n : t <= n ? this._progressTime = 0 : t >= s.endTime && (this._progressTime = s.repeatTime + 1e-11),
                            s.isReversed && (t = s.endTime - this._progressTime),
                            null == this._prevTime ? (this._prevTime = t,
                            this._wasUknownUpdate = !0,
                            !1) : (t >= n && t <= s.endTime && this._progress((t - n) / s.repeatTime, t),
                            t >= s.startTime && t <= s.endTime ? this._updateInActiveArea(t) : this._isInActiveArea ? this._updateInInactiveArea(t) : this._isRefreshed || t < s.startTime && 0 !== this.progress && (this._refresh(!0),
                            this._isRefreshed = !0),
                            this._prevTime = t,
                            t >= s.endTime || t <= n)
                        }
                        ...
                        value: function(t) {
                            if (this._isInActiveArea) {
                                ...
                                t < this._prevTime && t < e.startTime && !this._isStarted && !this._isCompleted && (this._progress(0, t, !1),
                        ...
                        value: function(t) {
                            ...
                            i + s >= e.startTime) {
                                ...
                                this._isRepeatStart = !1,
                                this._isStarted = !1;
                                var _ = (t - e.startTime) % r / e.duration
                                  , f = a > 0 && l < a
                                  , d = l > a;
                                if (this._onEdge = 0,
                                f && (this._onEdge = 1),
                                d && (this._onEdge = -1),
                                this._wasUknownUpdate && (t > this._prevTime && (this._start(t, h),
                                this._repeatStart(t, h),
                                this._firstUpdate(t, h)),
                                t < this._prevTime && (this._complete(t, h),
                                this._repeatComplete(t, h),
                                this._firstUpdate(t, h),
                                this._isCompleted = !1)),
                                f) {
                                ...
                                t > this._prevTime && (!this._isStarted && this._prevTime <= e.startTime && (this._start(t, h),
                                this._repeatStart(t, h),
                                this._isStarted = !1,
                                this._isRepeatStart = !1),
                                this._firstUpdate(t, h)),
                                d && (0 !== this.progress && 1 !== this.progress && l != n && this._repeatStart(t, p),
                                l !== n || this._wasUknownUpdate || (this._complete(t, h),
                                this._repeatComplete(t, h),
                                this._firstUpdate(t, h),
                                this._isCompleted = !1),
                                this._repeatComplete(t, h)),
                                "delay" === l && (a < u && this._repeatComplete(t, h),
                                a === u && a > 0 && this._repeatStart(t, h)),
                                t > this._prevTime ? (0 === _ && this._repeatStart(t, h),
                                t !== e.endTime && this._setProgress(h ? 1 - _ : _, t, h)) : (t !== e.endTime && this._setProgress(h ? 1 - _ : _, t, h),
                                0 === _ && this._repeatStart(t, h)),
                                t === e.startTime && this._start(t, h)
                            } else if (this._isInActiveArea) {
                                var v = "delay" === a ? o : a
                                  , m = t > this._prevTime;
                                m && v--,
                                c = e.isYoyo && v % 2 == 1 ? 1 : 0,
                                t < this._prevTime && (this._setProgress(c, t, 1 === c),
                        ...
                        value: function(t) {
                            var e = this._props
                              ...
                              , s = i / r
                              , n = t < e.endTime ? i % r : 0;
                            return s = t >= e.endTime ? Math.round(s) : Math.floor(s),
                            t > e.endTime ? s = Math.round((e.endTime - e.startTime + e.delay) / r) : n > 0 && n < e.delay && (this._delayT = s,
                            s = "delay"),
                            s
                        }
                    }, {
                        ...
                        value: function(t, e, r) {
                            ...
                            return (i.prevEasedProgress !== this.easedProgress || s) && null != i.onUpdate && "function" == typeof i.onUpdate && i.onUpdate.call(i.callbacksContext || this, this.easedProgress, this.progress, n, r),
                        ...
                        value: function(t, e) {
                            if (!this._isStarted) {
                                var r = this._props;
                                null != r.onStart && "function" == typeof r.onStart && r.onStart.call(r.callbacksContext || this, t > this._prevTime, e),
                                this._isCompleted = !1,
                                this._isStarted = !0,
                                this._isFirstUpdate = !1
                            }
                        ...
                        value: function(t, e) {
                            if (!this._isFirstUpdate) {
                                var r = this._props;
                                null != r.onFirstUpdate && "function" == typeof r.onFirstUpdate && (r.onFirstUpdate.tween = this,
                                r.onFirstUpdate.call(r.callbacksContext || this, t > this._prevTime, e)),
                        ...
                        value: function(t, e) {
                            if (!this._isRepeatCompleted) {
                                var r = this._props;
                                null != r.onRepeatComplete && "function" == typeof r.onRepeatComplete && r.onRepeatComplete.call(r.callbacksContext || this, t > this._prevTime, e),
                        ...
                        value: function(t, e) {
                            if (!this._isRepeatStart) {
                                var r = this._props;
                                null != r.onRepeatStart && "function" == typeof r.onRepeatStart && r.onRepeatStart.call(r.callbacksContext || this, t > this._prevTime, e),
                        ...
                        value: function(t, e) {
                            (0,
                            a.Z)((0,
                            u.Z)(r.prototype), "_setProp", this).call(this, t, e),
                            this._calcDimentions()
                        }
                    }, {
                        key: "_assignProp",
                        value: function(t, e) {
                            ...
                            "easing" === t && ((e = c().parseEasing(e))._parent = this);
                            var i = this._callbackOverrides[t]
                              , s = !e || !e.isMojsCallbackOverride;
                            i && s && (e = this._overrideCallback(e, i)),
                            (0,
                            a.Z)((0,
                            u.Z)(r.prototype), "_assignProp", this).call(this, t, e)
                        }
                    }, {
                        ...
                        value: function(t, e) {
                            ...
                            return i.isMojsCallbackOverride = !0,
                            i
                        }
                    }]),
                    r
            ...
            47: (t,e,r)=>{
                ...
                const n = new (function() {
                    ...
                    s.Z)(t, [{
                        ...
                        key: "_loop",
                        value: function() {
                            return !!this._isRunning && (this._update(window.performance.now()),
                            this.tweens.length ? (requestAnimationFrame(this._loop),
                            this) : this._isRunning = !1)
                        }
                    }, {
                        key: "_startLoop",
                        value: function() {
                        ...
                        value: function(t) {
                            ...
                            -1 !== e && (t = this.tweens[e]) && (t._isRunning = !1,
                        ...
                        value: function() {
                            void 0 !== document.hidden ? (this._visibilityHidden = "hidden",
                            this._visibilityChange = "visibilitychange") : void 0 !== document.mozHidden ? (this._visibilityHidden = "mozHidden",
                            this._visibilityChange = "mozvisibilitychange") : void 0 !== document.msHidden ? (this._visibilityHidden = "msHidden",
                            this._visibilityChange = "msvisibilitychange") : void 0 !== document.webkitHidden && (this._visibilityHidden = "webkitHidden",
            ...
            977: (t,e,r)=>{
                ...
                i = new (function() {
                    ...
                    ,
                    t.prototype.generate = function(t, e, r, i) {
                        var s, n, a, o, l, u, h, p, c, _, f, d, y, v, m, g, k, w, b, S, P, T, x, C;
                        if (arguments.length < 4)
                            return this.error("Bezier function expects 4 arguments");
                        for (k = w = 0; w < 4; k = ++w)
                            if ("number" != typeof (c = arguments[k]) || isNaN(c) || !isFinite(c))
                                return this.error("Bezier function expects 4 arguments");
                        return t < 0 || t > 1 || r < 0 || r > 1 ? this.error("Bezier x values should be > 0 and < 1") : (o = 4,
                        l = .001,
                        h = 1e-7,
                        u = 10,
                        b = 1 / ((S = 11) - 1),
                        ...
                        ,
                        f = function(t, e, r) {
                            return ((s(e, r) * t + n(e, r)) * t + a(e)) * t
                        }
                        ,
                        m = function(t, e, r) {
                            return 3 * s(e, r) * t * t + 2 * n(e, r) * t + a(e)
                        }
                        ,
                        T = function(e, i) {
                            var s;
                        ...
                        _ = function(e, i, s) {
                            ...
                            for (a = void 0,
                            n = void 0,
                            k = 0; (a = f(n = i + (s - i) / 2, t, r) - e) > 0 ? s = n : i = n,
                            Math.abs(a) > h && ++k < u; )
                                ;
                            return n
                        }
                        ...
                        g = function(e) {
                            ...
                            s = P[i + 1] - P[i],
                            n = (e - P[i]) / s,
                            (o = m(a = u + n * b, t, r)) >= l ? T(e, a) : 0 === o ? a : _(e, u, u + b)
                        }
                        ,
                        x = function() {
                            if (t !== e || r !== i)
                        ...
                        ,
                        P = v ? new Float32Array(S) : new Array(S),
                        p = !1,
                        C = "bezier(" + [t, e, r, i] + ")",
                        (y = function(s) {
                            return p || x(),
                            t === e && r === i ? s : 0 === s ? 0 : 1 === s ? 1 : f(g(s), e, i)
                        }
                        ).toStr = function() {
                            return C
                        }
            ...
            283: (t,e,r)=>{
                ...
                i = function() {
                    ...
                    t.prototype.ease = {
                        in: o.apply(t, [.42, 0, 1, 1]),
                        out: o.apply(t, [0, 0, .58, 1]),
                        inout: o.apply(t, [.42, 0, .58, 1])
                    },
                    t.prototype.sin = {
                        in: function(t) {
                    ...
                    t.prototype.back = {
                        ...
                        inout: function(t) {
                            var e;
                            return e = 2.5949095,
                            (t *= 2) < 1 ? t * t * ((e + 1) * t - e) * .5 : .5 * ((t -= 2) * t * ((e + 1) * t + e) + 2)
                        }
                    },
                    t.prototype.elastic = {
                        in: function(t) {
                    ...
                    t.prototype.bounce = {
                        ...
                        inout: function(t) {
                            return t < .5 ? .5 * l.bounce.in(2 * t) : .5 * l.bounce.out(2 * t - 1) + .5
                        }
                    },
                    t.prototype.parseEasing = function(t) {
                        var e;
                        return null == t && (t = "linear.none"),
                        "string" == typeof t ? "m" === t.charAt(0).toLowerCase() ? this.path(t) : (e = this[(t = this._splitEasing(t))[0]]) ? e[t[1]] : (u.error('Easing with name "' + t[0] + '" was not found, fallback to "linear.none" instead'),
                        this.linear.none) : u.isArray(t) ? this.bezier.apply(this, t) : t
                    }
                    ,
                    t.prototype._splitEasing = function(t) {
                        var e;
                        return "function" == typeof t ? t : "string" == typeof t && t.length ? [(e = t.split("."))[0].toLowerCase() || "linear", e[1].toLowerCase() || "none"] : ["linear", "none"]
                    }
                    ,
                    t
                }(),
            ...
            ,
            440: t=>{
                var e, r, i, s, n, a, o = [].slice;
                r = null,
                n = function(t) {
                    return "number" == typeof t.value ? t.value : r.parseEasing(t.value)
                }
                ,
                a = function(t, e) {
                    var r;
                ...
                s = function() {
                    var t;
                    return (t = 1 <= arguments.length ? o.call(arguments, 0) : []).length > 1 ? t = t.sort(a) : t[0].value = n(t[0]),
                    function(e) {
                        var r, s;
                        if (-1 !== (r = i(t, e)))
                            return s = t[r].value,
                            r === t.length - 1 && e > t[r].to ? 1 : "function" == typeof s ? s(e) : s
                    }
                }
                ,
                e = function(t) {
            ...
            162: (t,e,r)=>{
                ...
                i = function() {
                    ...
                    return t.prototype._vars = function() {
                        return this._precompute = s.clamp(this.o.precompute || 1450, 100, 1e4),
                        this._step = 1 / this._precompute,
                        this._rect = this.o.rect || 100,
                        this._approximateMax = this.o.approximateMax || 5,
                        this._eps = this.o.eps || .001,
                    ...
                    t.prototype._preSample = function() {
                        ...
                        a = [],
                        t = e = 0,
                        n = this._precompute; 0 <= n ? e <= n : e >= n; t = 0 <= n ? ++e : --e)
                            s = t * this._step,
                            r = this.pathLength * s,
                            i = this.path.getPointAtLength(r),
                            a.push(this._samples[t] = {
                                point: i,
                                length: r,
                                progress: s
                            });
                    ...
                    t.prototype._findBounds = function(t, e) {
                        ...
                        if (e === this._boundsPrevProgress)
                            return this._prevBounds;
                        for (null == this._boundsStartIndex && (this._boundsStartIndex = 0),
                        o = t.length,
                        this._boundsPrevProgress > e ? (l = 0,
                        i = "reverse") : (l = o,
                        i = "forward"),
                        "forward" === i ? (_ = t[0],
                        s = t[t.length - 1]) : (_ = t[t.length - 1],
                        s = t[0]),
                        n = a = p = this._boundsStartIndex,
                        c = l; p <= c ? a < c : a > c; n = p <= c ? ++a : --a) {
                            if (h = (f = t[n]).point.x / this._rect,
                            u = e,
                            "reverse" === i && (r = h,
                            h = u,
                            u = r),
                            ...
                            _ = f,
                            this._boundsStartIndex = n
                        }
                        return this._boundsPrevProgress = e,
                        this._prevBounds = {
                            start: _,
                            end: s
                        }
                    ...
                    t.prototype.sample = function(t) {
                        var e, r;
                        return t = s.clamp(t, 0, 1),
                        e = this._findBounds(this._samples, t),
                        null != (r = this._checkIfBoundsCloseEnough(t, e)) ? r : this._findApproximate(t, e.start, e.end)
                    }
                    ,
                    ...
                    t.prototype._checkIfPointCloseEnough = function(t, e) {
                        if (s.closeEnough(t, e.x / this._rect, this._eps))
                            return this._resolveY(e)
                    }
                    ,
                    t.prototype._approximate = function(t, e, r) {
                        var i, s;
                        return i = e.point.x - t.point.x,
                    ...
                    t.prototype._findApproximate = function(t, e, r, i) {
                        var n, a, o, l, u;
                        return null == i && (i = this._approximateMax),
                        n = this._approximate(e, r, t),
                        u = (l = this.path.getPointAtLength(n)).x / this._rect,
                        s.closeEnough(t, u, this._eps) || --i < 1 ? this._resolveY(l) : (o = {
                            point: l,
                            length: n
                        },
                        a = t < u ? [t, e, o, i] : [t, o, r, i],
                    ...
                    t.prototype._normalizePath = function(t) {
                        var e, r, i, s;
                        return s = /[M|L|H|V|C|S|Q|T|A]/gim,
                        (i = t.split(s)).shift(),
                        e = t.match(s),
                        i[0] = this._normalizeSegment(i[0]),
                        i[r = i.length - 1] = this._normalizeSegment(i[r], this._rect || 100),
                    ...
                    t.prototype._normalizeSegment = function(t, e) {
                        ...
                        t = t.trim(),
                        a = /(-|\+)?((\d+(\.(\d|\e(-|\+)?)+)?)|(\.?(\d|\e|(\-|\+))+))/gim,
                        u = (s = (o = this._getSegmentPairs(t.match(a)))[o.length - 1])[0],
                        Number(u) !== e)
                            for (t = "",
                            s[0] = e,
                            r = i = 0,
                    ...
                    t.prototype._getSegmentPairs = function(t) {
                        var e, r, i, n, a;
                        for (t.length % 2 != 0 && s.error("Failed to parse the path - segment pairs are not even.", t),
                        n = [],
                        e = r = 0,
                        i = t.length; r < i; e = r += 2)
                            t[e],
                            a = [t[e], t[e + 1]],
                            n.push(a);
                        return n
                    ...
                    t.prototype.create = function(e, r) {
                        var i;
                        return (i = new t(e,r)).sample.path = i.path,
                        i.sample
                    }
                    ,
                    t
            ...
            52: t=>{
                ...
                e = function() {
                    ...
                    return t.prototype.NS = "http://www.w3.org/2000/svg",
                    ...
                    t.prototype.getRemBase = function() {
                        var t, e;
                        return t = document.querySelector("html"),
                    ...
                    t.prototype.setPrefixedStyle = function(t, e, r) {
                        return "transform" === e && (t.style["" + this.prefix.css + e] = r),
                        t.style[e] = r
                    }
                    ,
                    t.prototype.style = function(t, e, r) {
                        var i, s, n, a;
                        if ("object" == typeof e) {
                            for (n = (s = Object.keys(e)).length,
                            a = []; n--; )
                                r = e[i = s[n]],
                                a.push(this.setPrefixedStyle(t, i, r));
                            return a
                        }
                    ...
                    t.prototype.prepareForLog = function(t) {
                        return (t = Array.prototype.slice.apply(t)).unshift("::"),
                    ...
                    t.prototype.parseUnit = function(t) {
                        ...
                        return "number" == typeof t ? {
                            ...
                            value: t,
                            string: 0 === t ? "" + t : t + "px"
                        } : "string" == typeof t ? (s = /px|%|rem|em|ex|cm|ch|mm|in|pt|pc|vh|vw|vmin|deg/gim,
                        r = !0,
                        (n = null != (i = t.match(s)) ? i[0] : void 0) || (n = "px",
                        r = !1),
                        {
                            unit: n,
                            isStrict: r,
                    ...
                    t.prototype.getRadialPoint = function(t) {
                        var e, r, i;
                        return null == t && (t = {}),
                        e = .017453292519943295 * (t.rotate - 90),
                    ...
                    t.prototype.getPrefix = function() {
                        var t, e, r;
                        return r = window.getComputedStyle(document.documentElement, ""),
                        t = (Array.prototype.slice.call(r).join("").match(/-(moz|webkit|ms)-/) || "" === r.OLink && ["", "o"])[1],
                        {
                    ...
                    t.prototype.strToArr = function(t) {
                        var e, r;
                        return e = [],
                        "number" != typeof t || isNaN(t) ? (t.trim().split(/\s+/gim).forEach((r = this,
                        function(t) {
                            return e.push(r.parseUnit(r.parseIfRand(t)))
                        }
                        )),
                        e) : (e.push(this.parseUnit(t)),
                        e)
                    }
                    ,
                    t.prototype.calcArrDelta = function(t, e) {
                        ...
                        n = t.length; s < n; i = ++s)
                            t[i],
                            r[i] = this.parseUnit("" + (e[i].value - t[i].value) + e[i].unit);
                        return r
                    }
                    ,
                    ...
                    t.prototype.normDashArrays = function(t, e) {
                        ...
                        if ((r = t.length) > (i = e.length))
                            ...
                            p = e.length,
                            n = a = 0,
                            u = l; 0 <= u ? a < u : a > u; n = 0 <= u ? ++a : --a)
                                s = n + p,
                                e.push(this.parseUnit("0" + t[s].unit));
                        else if (i > r)
                            for (l = i - r,
                            p = t.length,
                            n = o = 0,
                            h = l; 0 <= h ? o < h : o > h; n = 0 <= h ? ++o : --o)
                                s = n + p,
                                t.push(this.parseUnit("0" + e[s].unit));
                        return [t, e]
                    }
                    ,
                    t.prototype.makeColorObj = function(t) {
                        var e, r, i, s, n, a, o, l;
                        return "#" === t[0] && (i = {},
                        (o = /^#?([a-f\d]{1,2})([a-f\d]{1,2})([a-f\d]{1,2})$/i.exec(t)) && (a = 2 === o[1].length ? o[1] : o[1] + o[1],
                        s = 2 === o[2].length ? o[2] : o[2] + o[2],
                        r = 2 === o[3].length ? o[3] : o[3] + o[3],
                        i = {
                            r: parseInt(a, 16),
                            g: parseInt(s, 16),
                            b: parseInt(r, 16),
                        ...
                        "#" !== t[0] && ((n = "r" === t[0] && "g" === t[1] && "b" === t[2]) && (l = t),
                        n || (l = this.shortColors[t] ? this.shortColors[t] : (this.div.style.color = t,
                        this.computedStyle(this.div).color)),
                        o = new RegExp("^rgba?\\((\\d{1,3}),\\s?(\\d{1,3}),\\s?(\\d{1,3}),?\\s?(\\d{1}|0?\\.\\d{1,})?\\)$","gi").exec(l),
                        i = {},
                        e = parseFloat(o[4] || 1),
                        o && (i = {
                            r: parseInt(o[1], 10),
                    ...
                    t.prototype.parseStagger = function(t, e) {
                        var r, i, s, n, a, o;
                        return s = (o = t.split(/stagger\(|\)$/)[1].toLowerCase()).split(/(rand\(.*?\)|[^\(,\s]+)(?=\s*,|\s*$)/gim),
                        o = s.length > 3 ? (r = this.parseUnit(this.parseIfRand(s[1])),
                        s[3]) : (r = this.parseUnit(0),
                        s[1]),
                        o = this.parseIfRand(o),
                        i = e * (a = this.parseUnit(o)).value + r.value,
                        (n = r.isStrict ? r.unit : a.isStrict ? a.unit : "") ? "" + i + n : i
                    }
                    ,
                    ...
                    t.prototype.parseDelta = function(t, e, r) {
                        ...
                        if (null != (n = (e = this.cloneObj(e)).easing) && (n = mojs.easing.parseEasing(n)),
                        delete e.easing,
                        ...
                        !isNaN(parseFloat(c)) || c.match(/rand\(/) || c.match(/stagger\(/))
                            if ("strokeDasharray" === t || "strokeDashoffset" === t || "origin" === t) {
                                for (_ = this.strToArr(c),
                                o = this.strToArr(a),
                                this.normDashArrays(_, o),
                                u = h = 0,
                                p = _.length; h < p; u = ++h)
                                    c = _[u],
                                    a = o[u],
                                ...
                                this.callbacksMap[t] || this.tweenOptionMap[t] || (this.unitOptionMap[t] ? (a = this.parseUnit(this.parseStringOption(a, r)),
                                ...
                                s = {
                                    ...
                                    easing: n,
                                    curve: i
                                }) : (a = parseFloat(this.parseStringOption(a, r)),
                                s = {
                                    type: "number",
                                    name: t,
                            ...
                            if ("strokeLinecap" === t)
                                return this.warn("Sorry, stroke-linecap property is not animatable yet, using the start(" + c + ") value instead", e),
                                s;
                            s = {
                                type: "color",
                                name: t,
                    ...
                    t.prototype.mergeUnits = function(t, e, r) {
                        return !e.isStrict && t.isStrict ? (e.unit = t.unit,
                        e.string = "" + e.value + e.unit) : e.isStrict && !t.isStrict ? (t.unit = e.unit,
                        t.string = "" + t.value + t.unit) : e.isStrict && t.isStrict && e.unit !== t.unit ? (t.unit = e.unit,
                        t.string = "" + t.value + t.unit,
                        this.warn('Two different units were specified on "' + r + '" delta property, mo · js will fallback to end "' + e.unit + '" unit ')) : void 0
                    }
                    ,
                    ...
                    t.prototype.isDOM = function(t) {
                        var e;
                        return null != t && (e = "number" == typeof t.nodeType && "string" == typeof t.nodeName,
                        "object" == typeof t && e)
                    }
                    ,
                    ...
                    t.prototype.delta = function(t, e) {
                        var r, i, s, n, a;
                        if (a = typeof e,
                        r = "string" == (n = typeof t) || "number" === n && !isNaN(t),
                        i = "string" === a || "number" === a && !isNaN(e),
                        r && i)
                            return (s = {})[t] = e,
                            s;
                    ...
                    t.prototype.parsePath = function(t) {
                        var e;
                        return "string" == typeof t ? "m" === t.charAt(0).toLowerCase() ? ((e = document.createElementNS(this.NS, "path")).setAttributeNS(null, "d", t),
                        e) : document.querySelector(t) : t.style ? t : void 0
                    }
                    ,
                    ...
                    t.prototype.checkIf3d = function() {
                        ...
                        "" !== (null != (r = t.style)[e = this.prefix.css + "transform"] ? r[e] : r.transform)
                    }
                    ,
                    ...
                    t.prototype.parseStringOption = function(t, e) {
                        return null == e && (e = 0),
                        "string" == typeof t && (t = this.parseIfStagger(t, e),
                    ...
                    t.prototype.parseEl = function(t) {
                        return r.isDOM(t) || ("string" == typeof t && (t = document.querySelector(t)),
                        null === t && r.error("Can't parse HTML element: ", t)),
                        t
                    }
                    ,
                    t.prototype.force3d = function(t) {
                        return this.setPrefixedStyle(t, "backface-visibility", "hidden"),
                        t
                    }
                    ,
            ...
            291: (t,e,r)=>{
                ...
                i = function() {
                    function t(t) {
                        var e, r;
                        this.o = null != t ? t : {},
                        this.calcHeight = (e = this.calcHeight,
                        r = this,
                        function() {
                    ...
                    t.prototype.vars = function() {
                        return this.getScaler = a.bind(this.getScaler, this),
                        this.resize = o,
                    ...
                    t.prototype.curveToPath = function(t) {
                        ...
                        return h = document.createElementNS(a.NS, "path"),
                        u = {
                        ...
                        t.shift.x < 0 && (c += 180),
                        r = "%" === (r = a.parseUnit(e.x)).unit ? r.value * p : r.value,
                        n = a.getRadialPoint({
                            center: {
                                x: _.x,
                                y: _.y
                        ...
                        i = "%" === (i = a.parseUnit(e.y)).unit ? i.value * p : i.value,
                        s = a.getRadialPoint({
                            center: {
                                x: n.x,
                                y: n.y
                        ...
                        h.setAttribute("d", "M" + _.x + "," + _.y + " Q" + s.x + "," + s.y + " " + u.x + "," + u.y),
                        h
                    }
                    ,
                    t.prototype.postVars = function() {
                        return this.props.pathStart = a.clamp(this.props.pathStart, 0, 1),
                        this.props.pathEnd = a.clamp(this.props.pathEnd, this.props.pathStart, 1),
                        this.rotate = 0,
                        this.speedX = 0,
                        this.speedY = 0,
                        this.blurX = 0,
                        ...
                        this.prevCoords = {},
                        this.blurAmount = 20,
                        this.props.motionBlur = a.clamp(this.props.motionBlur, 0, 1),
                        this.onUpdate = this.props.onUpdate,
                        this.o.el ? (this.el = this.parseEl(this.props.el),
                        this.props.motionBlur > 0 && this.createFilter(),
                        this.path = this.getPath(),
                        this.path.getAttribute("d") ? (this.len = this.path.getTotalLength(),
                        this.slicedLen = this.len * (this.props.pathEnd - this.props.pathStart),
                        this.startLen = this.props.pathStart * this.len,
                        this.fill = this.props.fill,
                        null != this.fill && (this.container = this.parseEl(this.props.fill.container),
                        this.fillRule = this.props.fill.fillRule || "all",
                        this.getScaler(),
                        null != this.container) ? (this.removeEvent(this.container, "onresize", this.getScaler),
                        this.addEvent(this.container, "onresize", this.getScaler)) : void 0) : (a.error("Path has no coordinates to work with, aborting"),
                        !0)) : (a.error('Missed "el" option. It could be a selector, DOMNode or another module.'),
                        !0)
                    }
                    ,
                    ...
                    t.prototype.createFilter = function() {
                        ...
                        this.el.style[a.prefix.css + "filter"] = "url(#" + this.filterID + ")"
                    }
                    ,
                    t.prototype.parseEl = function(t) {
                        return "string" == typeof t ? document.querySelector(t) : t instanceof HTMLElement ? t : null != t._setProp ? (this.isModule = !0,
                        t) : void 0
                    }
                    ,
                    ...
                    t.prototype.getScaler = function() {
                        ...
                        this.fillRule) {
                        case "all":
                            return this.calcWidth(e),
                            this.calcHeight(e);
                        case "width":
                            return this.calcWidth(e),
                            this.scaler.y = this.scaler.x;
                        case "height":
                            return this.calcHeight(e),
                            this.scaler.x = this.scaler.y
                        }
                    }
                    ,
                    t.prototype.calcWidth = function(t) {
                        return this.scaler.x = this.cSize.width / t.width,
                        !isFinite(this.scaler.x) && (this.scaler.x = 1)
                    }
                    ,
                    t.prototype.calcHeight = function(t) {
                        return this.scaler.y = this.cSize.height / t.height,
                    ...
                    t.prototype.run = function(t) {
                        var e, r;
                        if (t) {
                            for (e in this.history[0],
                            t)
                                r = t[e],
                                a.callbacksMap[e] || a.tweenOptionMap[e] ? (a.warn('the property "' + e + '" property can not be overridden on run yet'),
                                delete t[e]) : this.history[0][e] = r;
                            this.tuneOptions(t)
                        }
                    ...
                    t.prototype.createTween = function() {
                        ...
                        return this.tween = new n({
                            ...
                            onFirstUpdate: function(t) {
                                return function(e, r) {
                                    if (!e)
                                        return t.history.length > 1 && t.tuneOptions(t.history[0])
                                }
                            }(this)
                        }),
                        this.timeline = new s,
                    ...
                    t.prototype.setProgress = function(t, e) {
                        var r, i, s, n;
                        return r = this.startLen + (this.props.isReverse ? (1 - t) * this.slicedLen : t * this.slicedLen),
                        s = (i = this.path.getPointAtLength(r)).x + this.props.offsetX,
                        n = i.y + this.props.offsetY,
                        this._getCurrentRotation(i, r, t),
                    ...
                    t.prototype.setElPosition = function(t, e, r) {
                        var i;
                        return i = "translate(" + t + "px," + e + "px) " + (0 !== this.rotate ? "rotate(" + this.rotate + "deg)" : "") + " " + (this.props.isCompositeLayer && a.is3d ? "translateZ(0)" : ""),
                    ...
                    ,
                    t.prototype._getCurrentRotation = function(t, e, r) {
                        var i, s, n, o, l;
                        return s = "function" == typeof this.props.transformOrigin,
                        this.props.isRotation || null != this.props.rotationOffset || s ? (n = this.path.getPointAtLength(e - 1),
                        o = t.y - n.y,
                        l = t.x - n.x,
                        i = Math.atan(o / l),
                        !isFinite(i) && (i = 0),
                        this.rotate = i * a.RAD_TO_DEG,
                    ...
                    t.prototype._setTransform = function(t, e, r, i) {
                        var s;
                        return this.scaler && (t *= this.scaler.x,
                        e *= this.scaler.y),
                        s = null,
                        i || (s = "function" == typeof this.onUpdate ? this.onUpdate(r, {
                            x: t,
                            y: e,
                            rotate: this.rotate
                        }) : void 0),
                        this.isModule ? this.setModulePosition(t, e) : "string" != typeof s ? this.setElPosition(t, e, r) : a.setPrefixedStyle(this.el, "transform", s)
                    }
                    ,
                    t.prototype._setTransformOrigin = function(t) {
                        var e;
                        if (this.props.transformOrigin)
                            return e = "function" == typeof this.props.transformOrigin ? this.props.transformOrigin(this.rotate, t) : this.props.transformOrigin,
                    ...
                    t.prototype.makeMotionBlur = function(t, e) {
                        ...
                        o = 1,
                        l = 1,
                        null == this.prevCoords.x || null == this.prevCoords.y ? (this.speedX = 0,
                        this.speedY = 0) : (s = t - this.prevCoords.x,
                        ...
                        r = u - this.rotate,
                        i = this.rotToCoords(r),
                        this.blurX = a.clamp(this.speedX / 16 * this.props.motionBlur, 0, 1),
                        this.blurY = a.clamp(this.speedY / 16 * this.props.motionBlur, 0, 1),
                        this.setBlur({
                            blur: {
                    ...
                    t.prototype.setBlur = function(t) {
                        if (!this.isMotionBlurReset)
                            return this.filter.setAttribute("stdDeviation", t.blur.x + "," + t.blur.y),
                    ...
                    t.prototype.then = function(t) {
                        var e, r, i, s, o, l;
                        for (r in i = {},
                        s = this.history[this.history.length - 1])
                            o = s[r],
                            !a.callbacksMap[r] && !a.tweenOptionMap[r] || "duration" === r ? null == t[r] && (t[r] = o) : null == t[r] && (t[r] = void 0),
                            a.tweenOptionMap[r] && (i[r] = "duration" !== r || null != t[r] ? t[r] : s[r]);
                    ...
                    t.prototype.tuneOptions = function(t) {
                        return this.extendOptions(t),
                        this.postVars()
                    }
                    ,
                    t.prototype.rotToCoords = function(t) {
                        var e, r, i;
                        return e = ((t %= 360) - 90) * Math.PI / 180,
                        r = Math.cos(e),
                        i = Math.sin(e),
                        {
                            x: 1.428571429 * (r = r < 0 ? Math.max(r, -.7) : Math.min(r, .7)),
                            y: 1.428571429 * (i = i < 0 ? Math.max(i, -.7) : Math.min(i, .7))
                        }
                    }
                    ,
                    t
            ...
            785: (t,e,r)=>{
                ...
                i = function(t) {
                    ...
                    e.prototype._declareDefaults = function() {
                        return e.__super__._declareDefaults.apply(this, arguments),
                        this._defaults.shape = "ellipse"
                    }
                    ,
                    e.prototype._draw = function() {
                        var t, r;
                        return t = null != this._props.radiusX ? this._props.radiusX : this._props.radius,
                    ...
                    e.prototype._getLength = function() {
                        var t, e;
                        return t = null != this._props.radiusX ? this._props.radiusX : this._props.radius,
                        e = null != this._props.radiusY ? this._props.radiusY : this._props.radius,
            ...
            158: (t,e,r)=>{
                ...
                i = function(t) {
                    ...
                    e.prototype._draw = function() {
                        var t, r, i, s, n, a, o;
                        if (e.__super__._draw.apply(this, arguments),
                        this._props,
                        s = null != this._props.radiusX ? this._props.radiusX : this._props.radius,
                        n = null != this._props.radiusY ? this._props.radiusY : this._props.radius,
                        r = s === this._prevRadiusX,
                        i = n === this._prevRadiusY,
                        !r || !i)
                            return t = "M" + ((a = this._props.width / 2) - s) + "," + (o = this._props.height / 2) + " L" + (a + s) + "," + o + " M" + a + "," + (o - n) + " L" + a + "," + (o + n),
            ...
            153: (t,e,r)=>{
                ...
                i = function(t) {
                    ...
                    e.prototype._draw = function() {
                        ...
                        if (e.__super__._draw.apply(this, arguments),
                        o = this._props,
                        this._props.points && (l = null != this._props.radiusX ? this._props.radiusX : this._props.radius,
                        u = null != this._props.radiusY ? this._props.radiusY : this._props.radius,
                        s = l === this._prevRadiusX,
                        n = u === this._prevRadiusY,
                        i = o.points === this._prevPoints,
                        !(s && n && i))) {
                            for (p = this._props.width / 2,
                            ...
                            d = f - u,
                            r = a = 0,
                            h = this._props.points; 0 <= h ? a < h : a > h; r = 0 <= h ? ++a : --a)
                                t += "M" + c + ", " + (f = "" + (r * y + d)) + " L" + _ + ", " + f + " ";
                            return this.el.setAttribute("d", t),
                            this._prevPoints = o.points,
                            this._prevRadiusX = l,
                            this._prevRadiusY = u
                        }
                    }
            ...
            878: (t,e,r)=>{
                ...
                i = function(t) {
                    ...
                    e.prototype._draw = function() {
                        ...
                        _ = null != this._props.radiusY ? this._props.radiusY : this._props.radius,
                        n = c === this._prevRadiusX,
                        a = _ === this._prevRadiusY,
                        i = h.points === this._prevPoints,
                        !(n && a && i)) {
                            for (y = 360 / this._props.points,
                            null == this._radialPoints ? this._radialPoints = [] : this._radialPoints.length = 0,
                            r = o = 0,
                            f = this._props.points; 0 <= f ? o < f : o > f; r = 0 <= f ? ++o : --o)
                                this._radialPoints.push(s.getRadialPoint({
                            ...
                            for (t = "",
                            r = l = 0,
                            u = (d = this._radialPoints).length; l < u; r = ++l)
                                t += (0 === r ? "M" : "L") + (p = d[r]).x.toFixed(4) + "," + p.y.toFixed(4) + " ";
            ...
            979: (t,e,r)=>{
                ...
                i = function(t) {
                    ...
                    e.prototype._draw = function() {
                        var t, r, i;
                        return e.__super__._draw.apply(this, arguments),
                        r = null != (t = this._props).radiusX ? t.radiusX : t.radius,
                        i = null != t.radiusY ? t.radiusY : t.radius,
            ...
            806: (t,e,r)=>{
                ...
                s = function() {
                    ...
                    return t.prototype.bit = i,
                    t.prototype.custom = l,
                    t.prototype.circle = n,
                    t.prototype.line = h,
                    t.prototype.zigzag = _,
                    t.prototype.rect = c,
                    ...
                    t.prototype.getShape = function(t) {
                        return this[t] || f.error('no "' + t + '" shape available yet, please choose from this list:', ["circle", "line", "zigzag", "rect", "polygon", "cross", "equal", "curve"])
                    }
                    ,
            ...
            322: (t,e,r)=>{
                ...
                i = function(t) {
                    ...
                    e.prototype._draw = function() {
                        ...
                        if (e.__super__._draw.apply(this, arguments),
                        u = this._props,
                        this._props.points && (p = null != this._props.radiusX ? this._props.radiusX : this._props.radius,
                        c = null != this._props.radiusY ? this._props.radiusY : this._props.radius,
                        n = p === this._prevRadiusX,
                        a = c === this._prevRadiusY,
                        s = u.points === this._prevPoints,
                        !(n && a && s))) {
                            for (t = u.width / 2 - p,
                            r = d = u.height / 2,
                            f = 2 * p / (u.points - 1),
                            ...
                            h = "M" + t + ", " + d + " ",
                            o = 0,
                            _ = u.points; 0 <= _ ? o < _ : o > _; 0 <= _ ? ++o : --o)
                                h += "L" + t + ", " + r + " ",
                                t += f,
                                l += i,
                                r = -1 === y ? d - c : d,
            ...
            247: (t,e)=>{
                ...
                i = function() {
                    function t(t) {
                        this.o = null != t ? t : {},
                        window.isAnyResizeEventInited || (this.vars(),
                        this.redefineProto())
                    }
                    return t.prototype.vars = function() {
                        return window.isAnyResizeEventInited = !0,
                    ...
                    t.prototype.redefineProto = function() {
                        ...
                        function() {
                            var i, s, n, a;
                            for (n = this.allowedProtos,
                            a = [],
                            t = i = 0,
                            s = n.length; i < s; t = ++i)
                                null != (r = n[t]).prototype && a.push(function(t) {
                                    return function(r) {
                                        var i;
                                        i = function() {
                                    ...
                                    function(e) {
                                        var r;
                                        return r = function() {
                                            return this.isAnyResizeEventInited = !1,
                    ...
                    t.prototype.handleResize = function(t) {
                        var e, r, i, s, n, a, o, l;
                        return r = t.that,
                        this.timerElements[r.tagName.toLowerCase()] ? this.initTimer(r) : (i = document.createElement("iframe"),
                        r.appendChild(i),
                        i.style.width = "100%",
                        i.style.height = "100%",
                        ...
                        (a || s) && (r.style.position = "relative"),
                        null != (o = i.contentWindow) && (o.onresize = (l = this,
                        function(t) {
                    ...
                    t.prototype.initTimer = function(t) {
                        ...
                        return r = 0,
                        e = 0,
                        this.interval = setInterval((i = this,
                        function() {
                            var s, n;
                            if (n = t.offsetWidth,
                            s = t.offsetHeight,
                    ...
                    t.prototype.dispatchEvent = function(t) {
                        var e;
                        return document.createEvent ? ((e = document.createEvent("HTMLEvents")).initEvent("onresize", !1, !1),
                    ...
                    t.prototype.destroy = function() {
                        var t, e, r, i, s, n;
                        for (clearInterval(this.interval),
                        this.interval = null,
                        window.isAnyResizeEventInited = !1,
                        n = [],
                        t = e = 0,
                        r = (s = this.allowedProtos).length; e < r; t = ++e)
                            null != (i = s[t]).prototype && n.push(function(t) {
                                return t.prototype.addEventListener || t.prototype.attachEvent,
                                t.prototype.addEventListener ? t.prototype.addEventListener = Element.prototype.addEventListener : t.prototype.attachEvent && (t.prototype.attachEvent = Element.prototype.attachEvent),
                                t.prototype.removeEventListener ? t.prototype.removeEventListener = Element.prototype.removeEventListener : t.prototype.detachEvent ? t.prototype.detachEvent = Element.prototype.detachEvent : void 0
                            }(i));
                        return n
                    }
                    ,
        ...
        return (()=>{
            ...
            const v = function(t) {
                ...
                function r() {
                    ...
                    return (0,
                    a.Z)(this, r),
                    (t = e.call(this, i))._transformTweenOptions(),
                ...
                o.Z)(r, [{
                    key: "play",
                    value: function() {
                        return this.timeline.play.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "playBackward",
                    value: function() {
                        return this.timeline.playBackward.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "pause",
                    value: function() {
                        return this.timeline.pause.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "stop",
                    value: function() {
                        return this.timeline.stop.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "reset",
                    value: function() {
                        return this.timeline.reset.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "replay",
                    value: function() {
                        return this.timeline.replay.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "replayBackward",
                    value: function() {
                        return this.timeline.replayBackward.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "resume",
                    value: function() {
                        return this.timeline.resume.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "setProgress",
                    value: function() {
                        return this.timeline.setProgress.apply(this.timeline, arguments),
                        this
                    }
                }, {
                    key: "setSpeed",
                    value: function() {
                        return this.timeline.setSpeed.apply(this.timeline, arguments),
                        this
                    }
                }, {
                ...
                o.Z)(i, [{
                    ...
                    value: function(t) {
                        ...
                        var e = this._history[this._history.length - 1]
                          , r = this._mergeThenOptions(e, t);
                        this._resetMergedFlags(r);
                        var i = new this.constructor(r);
                        return i._masterModule = this,
                    ...
                    value: function() {
                        (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_vars", this).call(this),
                    ...
                    value: function(t, e) {
                        var r = {};
                        return this._mergeStartLoop(r, t),
                    ...
                    value: function(t, r) {
                        for (var i in r) {
                            var s = r[i];
                            null != r[i] && (e().isTweenProp(i) && "duration" !== i || (this._isDelta(s) ? t[i] = e().getDeltaEnd(s) : t[i] = s))
                        }
                    }
                }, {
                    key: "_mergeEndLoop",
                    value: function(t, e, r) {
                        for (var i in r)
                            if ("parent" != i) {
                                var s = r[i]
                                  , n = null != e[i] ? e[i] : this._defaults[i];
                                if (n = this._checkStartValue(i, n),
                                null != s) {
                                    var a = "radiusX" === i || "radiusY" === i;
                                    a && null == n && (n = e.radius),
                                    (a = "scaleX" === i || "scaleY" === i) && null == n && (n = e.scale),
                    ...
                    value: function(t, r, i) {
                        ...
                        if (e().isTweenProp(t) || this._nonMergeProps[t] || a)
                            return i;
                        if (e().isObject(i) && null != i.to && (s = i.curve,
                        n = i.easing,
                        i = i.to),
                        this._isDelta(i))
                            return this._parseDeltaValues(t, i);
                        var o, l, u = this._parsePreArrayProperty(t, i);
                        return this._isDelta(r) ? (c(o = {}, e().getDeltaEnd(r), u),
                        c(o, "easing", n),
                        c(o, "curve", s),
                        o) : (c(l = {}, r, u),
                        c(l, "easing", n),
                    ...
                    value: function(t) {
                        var r = e().isObject(t);
                        return !(!(r = r && !t.unit) || e().isArray(t) || e().isDOM(t))
                    }
                }, {
                    key: "_isFirstInChain",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return t ? this === e().getLastItem(t._modules) : 1 === this._modules.length
                    }
                }]),
                i
            }(v);
                ...
                o.Z)(i, [{
                    ...
                    value: function(t) {
                        if (t && Object.keys(t).length) {
                            for (var r in this._transformHistory(t),
                            this._tuneNewOptions(t),
                            this._history[0] = e().cloneObj(this._props),
                            this._arrayPropertyMap)
                                null != t[r] && (this._history[0][r] = this._preparsePropValue(r, t[r]));
                    ...
                    value: function(t, r, i, s, n) {
                        ...
                        if (0 === t) {
                            ...
                            var l = this._isRewriteNext(a, o)
                              , u = this._isDelta(i) ? e().getDeltaEnd(i) : i;
                            return l ? u : null
                        }
                        return this._isDelta(a) ? (s[r] = c({}, i, e().getDeltaEnd(a)),
                        null) : (s[r] = i,
                        this._isRewriteNext(a, o) ? i : null)
                    }
                }, {
                    key: "_isRewriteNext",
                    value: function(t, r) {
                        ...
                        var i = t === r
                          ...
                          , n = !1
                          , a = !1;
                        return this._isDelta(t) && s ? e().getDeltaEnd(t) == e().getDeltaStart(r) && (a = !0) : s && (n = e().getDeltaStart(r) === "".concat(t)),
                        i || n || a
                    }
                }, {
                    key: "_tuneSubModules",
                    ...
                    value: function() {
                        ...
                        if (null != e) {
                            for (var r = 0; r < e.length; r++) {
                                var i = e[r]
                                  , s = e[r - 1];
                                t += s ? s._props.repeatTime : 0,
                                this._resetTween(i, this._history[r], t)
                            }
            ...
            var S = function(t) {
                ...
                o.Z)(i, [{
                    ...
                    value: function(t) {
                        ...
                        return this.timeline._recalcTotalDuration(),
                        this
                    }
                }, {
                    key: "tune",
                    ...
                    value: function(t, r, i) {
                        ...
                        var n = e().isArray(s) ? s[r % s.length] : s;
                        return e().parseIfStagger(n, r)
                    }
                }, {
                    ...
                    value: function(t, r) {
                        if ("number" == typeof t)
                            return t;
                        var i = r[t];
                        return e().isArray(i) || i + "" == "[object NodeList]" ? i.length : i + "" == "[object HTMLCollection]" ? Array.prototype.slice.call(i, 0).length : i instanceof HTMLElement || "string" == typeof i ? 1 : void 0
                    }
                }, {
                    key: "_init",
                    value: function(t, e) {
                        var r = this._getChildQuantity(t.quantifier || "el", t);
                        this._createTimeline(t),
                        this._modules = [];
                        for (var i = 0; i < r; i++) {
            ...
            const O = function(t) {
                ...
                o.Z)(i, [{
                    ...
                    value: function(t) {
                        return (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "tune", this).call(this, t),
                    ...
                    value: function(t) {
                        return (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "then", this).call(this, t),
                        this._getMaxSizeInChain(),
                        this
                    }
                }, {
                    ...
                    value: function() {
                        if (this.el) {
                            ...
                            this._setElSizeStyles(i, s),
                            t.isForce3d) {
                                var n = "backface-visibility";
                                r["".concat(n)] = "hidden",
                                r["".concat(e().prefix.css).concat(n)] = "hidden"
                            }
                        }
                    }
                }, {
                    ...
                    value: function(t, e) {
                        var r = this.el.style;
                        r.width = "".concat(t, "px"),
                        r.height = "".concat(e, "px"),
                        r["margin-left"] = "".concat(-t / 2, "px"),
                        r["margin-top"] = "".concat(-e / 2, "px")
                    }
                }, {
                    key: "_draw",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        var t = this._props
                          , r = this.el.style;
                        if (this._isPropChanged("opacity") && (r.opacity = t.opacity),
                        !this.isForeign) {
                            this._isPropChanged("left") && (r.left = t.left),
                            this._isPropChanged("top") && (r.top = t.top);
                            var i = this._isPropChanged("x")
                              , s = this._isPropChanged("y")
                              , n = i || s
                              , a = this._isPropChanged("scaleX")
                              , o = this._isPropChanged("scaleY")
                              , l = this._isPropChanged("scale")
                              , u = this._isPropChanged("rotate");
                            if (l = l || a || o,
                            n || l || u) {
                                var h = this._fillTransform();
                                r["".concat(e().prefix.css, "transform")] = h,
                                r.transform = h
                            }
                            if (this._isPropChanged("origin") || this._deltas.origin) {
                                var p = this._fillOrigin();
                                r["".concat(e().prefix.css, "transform-origin")] = p,
                                r["transform-origin"] = p
                            }
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        this._lastSet[t].value !== this._props[t] && (this._lastSet[t].value = this._props[t],
                        !0)
                    }
                }, {
                    key: "_tuneNewOptions",
                    value: function(t) {
                        if ((0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_tuneNewOptions", this).call(this, t),
                    ...
                    value: function(t) {
                        var e;
                        return e = this._getRadiusSize("radius"),
                    ...
                    value: function() {
                        ...
                        t.shapeWidth = null != t.width ? t.width : 2 * this._getMaxRadius("radiusX") + e,
                        t.shapeHeight = null != t.height ? t.height : 2 * this._getMaxRadius("radiusY") + e
                    }
                }, {
                    key: "_createShape",
                    value: function() {
                        if (this._getShapeSize(),
                    ...
                    key: "_setProgress",
                    value: function(t, e) {
                        d.Z.prototype._setProgress.call(this, t, e),
                        this._draw(t)
                    }
                }, {
            ...
            const D = function(t) {
                ...
                o.Z)(i, [{
                    ...
                    value: function() {
                        (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_declareDefaults", this).call(this),
                    ...
                    value: function() {
                        (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_extendDefaults", this).call(this),
                        this._calcPosData()
                    }
                }, {
                    key: "_tuneNewOptions",
                    ...
                    value: function() {
                        var t = this._getPosValue("x")
                          , r = this._getPosValue("y")
                          , i = 90 + Math.atan(r.delta / t.delta || 0) * e().RAD_TO_DEG;
                        this._posData = {
                    ...
                    value: function(t) {
                        ...
                        var i = e().parseUnit(this._props[t]);
                        return {
                            start: i.value,
                            end: i.value,
                            delta: 0,
                    ...
                    value: function(t) {
                        var r = this._props
                          , i = this._posData.rotate + r.degreeShift
                          , s = e().getRadialPoint({
                        ...
                        n < 0 && n > -1e-6 && (n = -1e-6),
                        a < 0 && a > -1e-6 && (a = -1e-6),
                        r.x = this._o.ctx ? n : "".concat(n).concat(this._posData.x.units),
                        r.y = this._o.ctx ? a : "".concat(a).concat(this._posData.y.units)
                    }
                }, {
                    key: "_getSwirl",
                    value: function(t) {
                ...
                o.Z)(i, [{
                    ...
                    value: function(t) {
                        ...
                        var e = this._masterThen(t)
                          , r = this._childThen(t);
                        return this._setSwirlDuration(e, this._calcPackTime(r)),
                        this.timeline._recalcTotalDuration(),
                        this
                    }
                }, {
                    key: "tune",
                    value: function(t) {
                        return null == t || (this._saveTimelineOptions(t),
                    ...
                    value: function(t) {
                        for (var r in e().tweenOptionMap)
                            null == this._defaults[r] && delete t[r]
                    }
                }, {
                    ...
                    value: function(t, e) {
                        for (var r = 1; r < t.length; r++) {
                            var i = t[r]
                              , s = {};
                            this._addBurstProperties(s, e, r),
                            i._tuneNewOptions(s)
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        var r = e().getLastItem(this.masterSwirl._modules);
                        return this._masterSwirls.push(r),
                        r
                    }
                }, {
                    key: "_childThen",
                    value: function(t) {
                        for (var r = this._swirls[0], i = [], s = 0; s < r.length; s++) {
                            var n = this._getChildOption(t, s)
                              , a = r[s];
                            n.parent = this.el,
                            this._addBurstProperties(n, s, this._masterSwirls.length - 1),
                            a.then(n),
                            i.push(e().getLastItem(a._modules))
                        }
                        return this._swirls[this._masterSwirls.length - 1] = i,
                        i
                    }
                }, {
                    key: "_vars",
                    ...
                    value: function() {
                        ...
                        this.masterSwirl = new L(this._o),
                    ...
                    value: function(t) {
                        this._timelineOptions = t.timeline,
                        delete t.timeline
                    }
                }, {
                    key: "_calcPackTime",
                    ...
                    value: function(t, e) {
                        ...
                        t.timeline && t.timeline._recalcTotalDuration && t.timeline._recalcTotalDuration()
                    }
                }, {
                    key: "_getChildOption",
                    value: function(t, e) {
                    ...
                    value: function(t, r) {
                        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
                          , s = i[t];
                        return e().isArray(s) ? s[r % s.length] : s
                    }
                }, {
                    ...
                    value: function(t, e, r) {
                        ...
                        var n = this._props
                          ...
                          , o = n.degree / a
                          , l = this._getSidePoint("start", e * o + s, r)
                          , u = this._getSidePoint("end", e * o + s, r);
                        t.x = this._getDeltaFromPoints("x", l, u),
                        t.y = this._getDeltaFromPoints("y", l, u),
                        t.rotate = this._getBitRotation(t.rotate || 0, s, e)
                    }
                }, {
                    key: "_getBitRotation",
                    value: function() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0
                          ...
                          , s = this._props
                          , n = s.degree % 360 == 0 ? s.count : s.count - 1 || 1
                          , a = s.degree / n
                          , o = i * a + 90;
                        if (o += r,
                        this._isDelta(t)) {
                            var l = {}
                              ...
                              , h = u[0]
                              , p = t[h];
                            h = e().parseStringOption(h, i),
                            p = e().parseStringOption(p, i),
                            l[parseFloat(h) + o] = parseFloat(p) + o,
                            t = l
                        } else
                            t += o;
                        return t
                    ...
                    value: function(t, e, r) {
                        var i = {};
                        return e[t] === r[t] ? i = e[t] : i[e[t]] = r[t],
                        i
                    }
                }, {
                    key: "_makeTimeline",
                    value: function() {
                        ...
                        (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_makeTimeline", this).call(this),
              ...
              , E = function(t) {
                ...
                o.Z)(r, [{
                    ...
                    value: function() {
                        (0,
                        _.Z)((0,
                        h.Z)(r.prototype), "_declareDefaults", this).call(this),
                        this._defaults.isSwirl = !1,
                        this._o.duration = null != this._o.duration ? this._o.duration : 700
                    }
                }, {
                    key: "_calcSwirlXY",
                    value: function(t) {
                        ...
                        (0,
                        _.Z)((0,
                        h.Z)(r.prototype), "_calcSwirlXY", this).call(this, t),
              ...
              , I = function() {
                ...
                o.Z)(t, [{
                    ...
                    value: function(t, e, r) {
                        ...
                        if (t.curve) {
                            var u = t.curve(r);
                            i = parseInt(u * (o.r + r * l.r), 10),
                            s = parseInt(u * (o.g + r * l.g), 10),
                            n = parseInt(u * (o.b + r * l.b), 10),
                            a = parseFloat(u * (o.a + r * l.a))
                        } else
                            i = parseInt(o.r + e * l.r, 10),
                            s = parseInt(o.g + e * l.g, 10),
                    ...
                    value: function(t, e, r) {
                        for (var i = t.name, s = this._o.props, n = "", a = t.curve ? t.curve(r) : null, o = 0; o < t.delta.length; o++) {
                            var l = t.delta[o]
                              , u = t.curve ? a * (t.start[o].value + r * l.value) : t.start[o].value + e * l.value;
            ...
            const H = function() {
                ...
                o.Z)(t, [{
                    ...
                    value: function(t, e) {
                        ...
                        return r.delta = this._parseDelta(t, r.delta),
                        r
                    }
                }, {
                    key: "_parseDelta",
                    ...
                    value: function(t) {
                        t = Y({}, t);
                        for (var e = Object.keys(t), r = {}, i = null, s = 0; s < e.length; s++) {
                            var n = e[s];
                            U[n] && (null != t[n] && (r[n] = t[n],
                            i = !0),
                            delete t[n])
                        }
                        return {
                    ...
                    value: function(t, r) {
                        if ("strokeLinecap" === t)
                            return e().warn("Sorry, stroke-linecap property is not animatable yet, using the start(#{start}) value instead", r),
                            {};
                        var i = this._preparseDelta(r)
                          , s = this._makeColorObj(i.start)
                          , n = this._makeColorObj(i.end);
                        return {
                            type: "color",
                            name: t,
                            start: s,
                    ...
                    value: function(t, r) {
                        var i = this._preparseDelta(r)
                          , s = this._strToArr(i.start)
                          , n = this._strToArr(i.end);
                        e().normDashArrays(s, n);
                        for (var a = 0; a < s.length; a++) {
                            var o = n[a];
                            e().mergeUnits(s[a], o, t)
                        }
                        return {
                            type: "array",
                            name: t,
                    ...
                    key: "_parseUnitDelta",
                    value: function(t, r, i) {
                        var s = this._preparseDelta(r)
                          , n = e().parseUnit(e().parseStringOption(s.end, i))
                          , a = e().parseUnit(e().parseStringOption(s.start, i));
                        return e().mergeUnits(a, n, t),
                        {
                            type: "unit",
                            name: t,
                            start: a,
                    ...
                    value: function(t, r, i) {
                        var s = this._preparseDelta(r)
                          , n = parseFloat(e().parseStringOption(s.end, i))
                          , a = parseFloat(e().parseStringOption(s.start, i));
                        return {
                            type: "number",
                            name: t,
                            start: a,
                    ...
                    value: function(t) {
                        var e = (t = Y({}, t)).curve;
                        null != e && ((e = x().parseEasing(e))._parent = this),
                        delete t.curve;
                    ...
                    value: function(t) {
                        ...
                        if ("#" === t[0]) {
                            ...
                            if (i) {
                                var s = 2 === i[1].length ? i[1] : i[1] + i[1]
                                  , n = 2 === i[2].length ? i[2] : i[2] + i[2]
                                  , a = 2 === i[3].length ? i[3] : i[3] + i[3];
                                r = {
                                    r: parseInt(s, 16),
                                    g: parseInt(n, 16),
                                    b: parseInt(a, 16),
                        ...
                        if ("#" !== t[0]) {
                            ...
                            l && (o = t),
                            l || (this._shortColors[t] ? o = this._shortColors[t] : (e().div.style.color = t,
                            o = e().computedStyle(e().div).color));
                            var u = new RegExp("^rgba?\\((\\d{1,3}),\\s?(\\d{1,3}),\\s?(\\d{1,3}),?\\s?(\\d{1}|0?\\.\\d{1,})?\\)$","gi").exec(o)
                              , h = parseFloat(u[4] || 1);
                            u && (r = {
                                r: parseInt(u[1], 10),
                                g: parseInt(u[2], 10),
                    ...
                    value: function(t) {
                        ...
                        return "number" != typeof t || isNaN(t) ? (t.trim().split(/\s+/gim).forEach((function(t) {
                            r.push(e().parseUnit(e().parseIfRand(t)))
                        }
                        )),
                        r) : (r.push(e().parseUnit(t)),
                        r)
                    }
                }]),
                t
            ...
            const $ = function(t) {
                ...
                o.Z)(i, [{
                    ...
                    value: function(t) {
                        if (null == t || !Object.keys(t).length)
                            return 1;
                        var r = e().getLastItem(this._modules);
                        return r.deltas.refresh(!1),
                    ...
                    key: "_checkStartValue",
                    value: function(t, r) {
                        return null == r ? null != this._defaults[t] ? this._defaults[t] : null != this._customProps[t] ? this._customProps[t] : null != e().defaultStyles[t] ? e().defaultStyles[t] : 0 : r
                    }
                }, {
                    key: "_draw",
                    value: function() {
                        ...
                        if (!this._o.prevChainModule) {
                            for (var t = this._props, e = 0; e < this._renderProps.length; e++) {
                                var r = this._renderProps[e]
                                  , i = t[r];
                                i = "number" == typeof i ? "".concat(i, "px") : i,
                                this._setStyle(r, i)
                            }
                            this._draw(),
                            t.isShowStart || this._hide()
                        }
                    }
                }, {
                    key: "_setStyle",
                    value: function(t, e) {
                        if (this._state[t] !== e) {
                            ...
                            r[t] = e,
                            this._prefixPropertyMap[t] && (r["".concat(this._prefix).concat(t)] = e),
                            this._state[t] = e
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        for (var r = Object.keys(t), i = 0; i < r.length; i++) {
                            var s = r[i]
                              , n = !this._drawExclude[s] && null == this._defaults[s] && !Q[s]
                              , a = this._customProps[s];
                            e().isDelta(t[s]) || Q[s] ? n && !a && this._drawProps.push(s) : (this._parseOption(s, t[s]),
                            "el" === s && (this._props.el = e().parseEl(t.el),
                            this.el = this._props.el),
                            n && !a && this._renderProps.push(s))
                        }
                    ...
                    value: function() {
                        ...
                        this._customProps = N({}, this._customProps),
                    ...
                    value: function(t) {
                        return (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_resetMergedFlags", this).call(this, t),
                        t.props = this._props,
                    ...
                    value: function(t, r) {
                        (0,
                        _.Z)((0,
                        h.Z)(i.prototype), "_parseOption", this).call(this, t, r);
                        var s = this._props[t];
                        e().isArray(s) && (this._props[t] = this._arrToString(s))
                    }
                }, {
                    key: "_arrToString",
                    value: function(t) {
                    ...
                    value: function(t) {
                        ...
                        return this._o.isForce3d && (this._is3d = !0),
                        t
                    }
                }, {
                    key: "_vars",
                    ...
                    value: function(t, r, i) {
                        ...
                        if (e().isTweenProp(t) || this._nonMergeProps[t] || s)
                            return i;
                        var n = {};
                        if (e().isObject(i) && null != i.to) {
                            for (var a in i)
                                (Q[a] || "curve" === a) && (n[a] = i[a],
                                delete i[a]);
                            i = i.to
                        ...
                        if (this._isDelta(i)) {
                            ...
                            for (var l in i)
                                (Q[l] || "curve" === l) && (o[l] = i[l],
                                delete i[l]);
                            return N(N({}, this._parseDeltaValues(t, i)), o)
                        }
                        var u = this._parsePreArrayProperty(t, i);
                        return this._isDelta(r) ? N(c({}, e().getDeltaEnd(r), u), n) : N(c({}, r, u), n)
                    }
                }]),
                i
            }(g)
              , K = function() {
                function t() {
                    ...
                    a.Z)(this, t),
                    this.o = r,
                    this.o.el ? (this._vars(),
                    this._declareDefaults(),
                    this._extendDefaults(),
                    this._parseFrames(),
                    this._frames.length <= 2 && e().warn("Spriter: only ".concat(this._frames.length, " frames found")),
                    this._frames.length < 1 && e().error("Spriter: there is no frames to animate, aborting"),
                    this._createTween(),
                    this) : e().error('No "el" option specified, aborting')
                }
                return (0,
                o.Z)(t, [{
                    key: "_declareDefaults",
